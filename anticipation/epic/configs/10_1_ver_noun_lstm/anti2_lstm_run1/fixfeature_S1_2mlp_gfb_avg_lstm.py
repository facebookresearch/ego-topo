...
test_cfg = None
# dataset settings
dataset_type = 'EpicFeatureDatasetGFBNode'
...
node_feat_file = "work_dir/lstm/verb_noun/nodelstm/lstm_feats_{}_anti2.pkl"
...
data = dict(
    ...
    train=dict(
        ...
        node_fb=node_feat_file.format("train"),
    ...
    val=dict(
        ...
        node_fb=node_feat_file.format("val"),
        graph_root=graph_root,
        test_mode=True,
        node_num_member=node_num_member,
        anti2=anti2,
