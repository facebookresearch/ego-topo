...
anticipation = True
# dataset settings
dataset_type = 'EpicFeatureDatasetLFB'
mode="_verb" # _verb|_noun|''
split="S1"
feature_file = "data/features/{}/".format(split) + "{}_lfb.pkl"
lfb_file = "data/features/{}/".format(split) + "{}_lfb.pkl"
lfb_window_mode = "end"
data = dict(
    videos_per_gpu=32,
    workers_per_gpu=8,
    train=dict(
        ...
        lfb=lfb_file.format("train"),
        lfb_window_mode=lfb_window_mode,
        test_mode=False,
...
log_level = 'INFO'
work_dir = 'work_dir/fixfeature/fixfeatures_{}_2mlp_lfb'.format(split)
load_from = None
resume_from = None
